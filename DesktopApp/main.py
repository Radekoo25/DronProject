...
def OpenConfigurationWindow():
    ...
    def SendConfiguration():
        ...
        label_send = tk.Label(configuration_window, text=text)
        label_send.config(font=('helvetica', 15))
        canvas_configuration_window.create_window((WIDTH / 2 + 10), 500, window=label_send)
